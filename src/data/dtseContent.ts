...
const PROTOCOL_BRIEF_OVERRIDES: Record<string, Omit<DTSEProtocolBrief, 'protocol_id' | 'protocol_name' | 'chain'>> = {
    ...
    helium_bme_v1: {
        ...
        supply_count: 180000000,
        supply_unit: 'tokens',
        supply_structure: 'Elastic',
        token_price_usd: 3,
        market_cap_usd: 540000000,
        weekly_emissions: 625000,
        weekly_emissions_unit: 'tokens/week',
        burn_fraction_pct: 100,
        active_providers: 370000,
        active_providers_unit: 'hotspots',
    ...
    adaptive_elastic_v1: {
        ...
        supply_count: 520000000,
        supply_unit: 'tokens',
        supply_structure: 'Elastic',
        token_price_usd: 4.5,
        market_cap_usd: 2340000000,
        weekly_emissions: 1000000,
        weekly_emissions_unit: 'tokens/week',
        burn_fraction_pct: 50,
        active_providers: 5000,
        active_providers_unit: 'providers',
    ...
    filecoin_v1: {
        ...
        supply_count: 500000000,
        supply_unit: 'tokens',
        supply_structure: 'Capped',
        token_price_usd: 6,
        market_cap_usd: 3000000000,
        weekly_emissions: 2000000,
        weekly_emissions_unit: 'tokens/week',
        burn_fraction_pct: 30,
        active_providers: 4000,
        active_providers_unit: 'providers',
    ...
    hivemapper_v1: {
        mechanism: 'Coverage Rewards + Freshness Incentives',
        depin_surface: 'Dashcam-powered map-to-earn network monetizing geospatial freshness.',
        supply_count: 4200000000,
        supply_unit: 'tokens',
        supply_structure: 'Capped',
        token_price_usd: 0.18,
        market_cap_usd: 756000000,
        weekly_emissions: 18000000,
        weekly_emissions_unit: 'tokens/week',
        burn_fraction_pct: 15,
        active_providers: 90000,
        active_providers_unit: 'contributors',
    ...
    dimo_v1: {
        mechanism: 'Data Sharing Rewards + Settlement Utility',
        depin_surface: 'User-owned vehicle telemetry network serving insurance and mobility demand.',
        supply_count: 1000000000,
        supply_unit: 'tokens',
        supply_structure: 'Capped',
        token_price_usd: 0.21,
        market_cap_usd: 210000000,
        weekly_emissions: 2500000,
        weekly_emissions_unit: 'tokens/week',
        burn_fraction_pct: 10,
        active_providers: 150000,
        active_providers_unit: 'vehicles',
    ...
    grass_v1: {
        mechanism: 'Bandwidth Incentives + Routing Rewards',
        ...
        weekly_emissions: 12000000,
        weekly_emissions_unit: 'tokens/week',
        burn_fraction_pct: 5,
        active_providers: 2500000,
        active_providers_unit: 'nodes',
    ...
    ionet_v1: {
        ...
        supply_unit: 'tokens',
        supply_structure: 'Capped',
        token_price_usd: 0.03,
        market_cap_usd: 15000000,
        weekly_emissions: 15000,
        weekly_emissions_unit: 'tokens/week',
        burn_fraction_pct: 90,
        active_providers: 20,
        active_providers_unit: 'providers',
    ...
    nosana_v1: {
        ...
        supply_count: 48000000,
        supply_unit: 'tokens',
        supply_structure: 'Capped',
        token_price_usd: 3.5,
        market_cap_usd: 168000000,
        weekly_emissions: 190000,
        weekly_emissions_unit: 'tokens/week',
        burn_fraction_pct: 0,
        active_providers: 3000,
        active_providers_unit: 'providers',
    ...
    geodnet_v1: {
        mechanism: 'Halving Emissions + Revenue Burn',
        depin_surface: 'RTK precision-location network funded by data demand and token incentives.',
        supply_count: 750000000,
        supply_unit: 'tokens',
        supply_structure: 'Capped',
        token_price_usd: 0.32,
        market_cap_usd: 240000000,
        weekly_emissions: 2500000,
        weekly_emissions_unit: 'tokens/week',
        burn_fraction_pct: 35,
        active_providers: 12000,
        active_providers_unit: 'stations',
    ...
    aleph_v1: {
        ...
        supply_count: 244000000,
        supply_unit: 'tokens',
        supply_structure: 'Capped',
        token_price_usd: 0.3,
        market_cap_usd: 73200000,
        weekly_emissions: 375000,
        weekly_emissions_unit: 'tokens/week',
        burn_fraction_pct: 10,
    ...
    xnet_v1: {
        mechanism: 'Coverage Rewards + Buy-and-Burn',
        ...
        weekly_emissions: 6000000,
        weekly_emissions_unit: 'tokens/week',
        burn_fraction_pct: 25,
        active_providers: 10000,
        active_providers_unit: 'radios',
...
function deriveDefaultProtocolBrief(profile: ProtocolProfileV1): Omit<DTSEProtocolBrief, 'protocol_id' | 'protocol_name' | 'chain'> {
    ...
    const supplyStructure = inferSupplyStructure(profile);
    return {
        mechanism: profile.metadata.mechanism,
        depin_surface: note.endsWith('.') ? note : `${note}.`,
        supply_count: profile.parameters.supply.value,
        supply_unit: profile.parameters.supply.unit,
        supply_structure: supplyStructure,
        token_price_usd: profile.parameters.initial_price.value,
        market_cap_usd: profile.parameters.supply.value * profile.parameters.initial_price.value,
        weekly_emissions: profile.parameters.emissions.value,
        weekly_emissions_unit: profile.parameters.emissions.unit,
        burn_fraction_pct: profile.parameters.burn_fraction.value * 100,
        active_providers: profile.parameters.initial_active_providers.value,
        active_providers_unit: isLocation ? 'nodes' : 'providers',
...
function inferSupplyStructure(profile: ProtocolProfileV1): DTSEProtocolBrief['supply_structure'] {
    const mechanism = profile.metadata.mechanism.toLowerCase();
    const notes = profile.metadata.notes.toLowerCase();
    if (mechanism.includes('burn-and-mint') || mechanism.includes('elastic')) {
        return 'Elastic';
    }
    if (notes.includes('uncapped')) {
        return 'Uncapped';
    }
    return 'Capped';
}
